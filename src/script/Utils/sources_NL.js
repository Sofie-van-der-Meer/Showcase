export default {
        ...
        sections:     [
            {
                ...
                title:        "Hey ik ben Sofie van der Meer",
    ...
    about: {
        ...
        sections:         {
            ...
            Overige_gegevens:    {
                beschikbaarheid:          "Beschikbaar vanaf 1 maart ‘25, sta open voor stage/IBO.",
                gerelateerde_intresses:   ["Virtual Realty", "2D & 3D Visuals"]
            }        
        }
    },
    projects: [
        ...
        },
        {
            ...
            sections:     {
                error:         "Dit project is momenteel in ontwikkeling en wordt binnenkort gepubliceerd."
            }
        },
        {
            headername:   "Project",
    ...
    contact: {
            ...
            subtitle:     [
                "Vul het onderstaande formulier in, of neem direct contact met mij op", 
                "sofievandermeer@outlook.com", 
                "(klik om te kopiëren)",
                "Verkiest u het contactformulier?"
            ],
            contactform:  [
                "Voornaam",
                "Achternaam",
